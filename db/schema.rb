...
ActiveRecord::Schema.define(version: 20180223074452) do
  ...
  create_table "permissions_users", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
