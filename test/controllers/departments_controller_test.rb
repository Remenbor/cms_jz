...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { coding: @department.coding, name: @department.name, parent: @department.parent } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { coding: @department.coding, name: @department.name, parent: @department.parent } }
